...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.peerId, @required this.peerAvatar, this.roomID, this.name}) : super(key: key);
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key key, @required this.peerId, @required this.peerAvatar, this.roomID, this.name}) : super(key: key);
...
class ChatScreenState extends State<ChatScreen> {
  ...
  readLocal() async {
    ...
    setState(() {});
    FirebaseFirestore.instance.collection('rooms').where('member', whereIn: [peerId, id ]).get().then((value) {
          setState(() {
